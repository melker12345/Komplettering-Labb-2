            ...
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between flex-wrap gap-8">
                    ...
                    <ul class="flex items-center gap-6 flex-wrap text-secondary dark:text-primary">
                        ...
                        <li class=" hover:text-opacity-70 transition duration-200"><a href="#">Features</a>
                        </li>
                        <li class=" hover:text-opacity-70 transition duration-200"><a href="#">How it
                                works</a></li>
                        <li class=" hover:text-opacity-70 transition duration-200"><a href="#">Resources</a>
                        </li>
